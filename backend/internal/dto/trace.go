...
type TraceDetail struct {
	...
	SnapshotLengthM         float64   `json:"snapshot_length_m"`
	SnapshotRefractiveIndex float64   `json:"snapshot_refractive_index"`
	SnapshotLaunchOffsetM   float64   `json:"snapshot_launch_offset_m"`
